...
From Customers as c;  -- to choose columns
go
Select c.CompanyName, c.ContactName, Country
From Customers as c
...
Order By c.Country, c.CompanyName; -- to order by 
go
...
go
Select c.CategoryName, p.ProductName, [Standard Price] = Format(p.UnitPrice,'c')
From Products as p Join Categories as c
On p.CategoryID = c.CategoryID
Order By c.CategoryName, p.ProductName;  -- to format with dollar sign
go
